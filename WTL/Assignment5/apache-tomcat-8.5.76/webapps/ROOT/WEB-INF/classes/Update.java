...
public class Update extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            out.println("<html>  ");
            out.println("    <body><h1> Update </h1>");
            out.println("        <form action='/update' method='post'>");
            out.println("            <label for='book_id'>Book id</label>");
            out.println("            <input type='text' name='book_id' id='book_id'> <br>");
            out.println("            <label for='book_name'>Book Name</label>");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            st.setInt(5, Integer.parseInt(request.getParameter("book_id")));
